...
/* harmony import */ var _modules_downland__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/downland */ "./src/js/modules/downland.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  new _modules_downland__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Downland; });
class Downland {
...
class Form {
  constructor(forms) {
    ...
    this.path = 'C:/MAMP/htdocs/test/assets/question.php';
  }
      ...
      btn.addEventListener('click', () => {
        if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
          ...
          if (document.querySelector('iframe#frame')) {
            ...
            this.path = btn.getAttribute('data-url');
            this.createPlayer(this.path); // this.createPlayer('dQw4w9WgXcQ');
          }
        }
      });
    });
